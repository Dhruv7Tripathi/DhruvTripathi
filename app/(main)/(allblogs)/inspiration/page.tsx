...
const TechnologyBlog = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">How Lord Hanuman Inspires Me</h1>
      ...
      <p className="mb-4">
        Despite facing numerous challenges, Hanuman never backed down. His leap across the ocean to Lanka symbolizes courage, determination, and an unshakable belief in one’s abilities. Whenever I face obstacles in life, I remind myself of Hanuman’s fearless attitude and push forward with confidence.      </p>
      {/* <p className="mb-6">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Humility and Wisdom</h2>
      <p className="mb-4">
